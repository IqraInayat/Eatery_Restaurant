...
@section('mycontent')
    <form action="{{ route('update_menu',['id' => $data->id ])  }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="price" class="form-control" id="price" placeholder="Enter Price..." value="{{ $data->price }}">
            <p class="text-danger">
                @error('price')
                    {{ $message }}
                @enderror
